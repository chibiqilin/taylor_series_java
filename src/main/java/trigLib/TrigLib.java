...
public abstract class TrigLib {
	 ...
	 * 
	 * @param denominator
	 *            input value for use as a denominator
	 ...
	 * 
	 * @param base
	 *            Base value in double
	 * @param exponent
	 *            Exponent value in Int
	...
	/*
	 * input is radian the default is RADIAN
	 */
	...
	/*
	 * input is radian using v5 from Roy
	 */
